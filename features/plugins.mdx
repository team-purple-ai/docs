...
To create your own plugin, see the [plugin development guide](/developers/creating-plugins). The plugin SDK provides TypeScript types, CLI tools, and templates to get started quickly.

Custom plugins can be:
- Installed from a git repository URL
- Shared with your team
- Published to the Purple plugin registry
