...
<CardGroup cols={2}>
  ...
  <Card title="Sessions" icon="comments" href="/sessions/overview">
    ### Sessions
...
p0 is powered by Anthropic's Claude models:

- **Claude Opus 4.5**: Maximum capability for complex reasoning and planning
- **Claude Sonnet 4.5**: Fast, efficient performance for most coding tasks

The model is automatically selected based on your task, or you can choose manually in session settings.
